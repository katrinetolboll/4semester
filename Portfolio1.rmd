...
library(pacman)
p_load(lme4, lmerTest, ggplot2, jpeg, grid, caret, mltools,Metrics)
...
# SHEEP
img <-readJPEG('C:\\Users\\katri\\OneDrive\\Dokumenter\\4semester\\eyetrackingscripts\\foraging\\ng021ws.jpg')
g <- rasterGrob(img, interpolate=TRUE) #to get the picture to show

img <- rasterGrob(img, interpolate=TRUE) #to get the picture to show 
...
# SHEEP
img3 <-readJPEG('C:\\Users\\katri\\OneDrive\\Dokumenter\\4semester\\eyetrackingscripts\\foraging\\ng021ws.jpg')
...
ggplot(subset(fixations, Task == 'VisualSearch' & ParticipantID == '1_1_f1' & Trial == 1),aes(x=PositionX, 
y=PositionY, label=Fixation)) + annotation_custom(g, xmin=-Inf, xmax=Inf, ymin=-0, ymax=1080) +
